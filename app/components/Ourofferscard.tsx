...
const Ourofferscard: React.FC<CustomerReviewCardProps> = ({ name, comment, profileImg }) => {
  return (
    <section className="relative lg:m-14 m-2 border">
      <div className="lg:p-10 p-6 rounded-3xl bg-gray-50 border-[2px] max-xl:max-w-2xl max-xl:mx-auto">
        ...
        <p className="font-normal text-lg text-gray-400 ">{comment}</p>
      </div>
    </section>
  );
};
