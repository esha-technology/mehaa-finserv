...
const CarouselBanner = () => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center h-[600px] w-[85%] mx-auto my-2 overflow-hidden bg-gray-100 rounded-lg shadow-lg">
  {/* Carousel slides */}
  <div
  ...
  <button
    onClick={prevSlide}
    className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-green-500/80 p-3 text-white hover:bg-green-600 transition-colors duration-300 hover:scale-110"
  ...
  <button
    onClick={nextSlide}
    className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-green-500/80 p-3 text-white hover:bg-green-600 transition-colors duration-300 hover:scale-110"
