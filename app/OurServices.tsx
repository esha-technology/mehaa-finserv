...
import WhyUseCard from "./components/common/WhyUseCards";
...
const OurServices: React.FC = () => {
  ...
  return (
    <div className="py-16 md:mt-5 lg:mt-16" ref={targetSectionRef} id="ourServices">
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-20">
          {services.map((service, index) => (
            <motion.div
              ...
              className="duration-200 border w-full md:w-[21%] lg:w-[20%] px-5 py-10 rounded-3xl mx-5 mb-10 flex flex-col items-center text-center "
            >
              <Link href="services/web-development">
                <div className="flex flex-col justify-center items-center">
                  ...
                  <h2 className="font-bold text-xl sm:text-2xl mb-4 mt-2">{service.title}</h2>
                  <p className="text-base sm:text-lg mb-4">{service.details}</p>
                  <Link href="services/web-development" className="text-sky-600 font-medium hover:underline flex gap-1">
